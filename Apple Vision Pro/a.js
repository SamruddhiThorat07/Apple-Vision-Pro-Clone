...
gsap.to(video, {
  scrollTrigger: {
    ...
    scrub: 1,
    markers: true, // Set to true to visualize trigger and scrubbing
    onEnter: () => video.play(),
    onLeave: () => video.pause(),
  },
  reversed: true,
